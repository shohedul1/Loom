  ...
  return (
    <div className="bg-[#e3f3ff] py-20 md:pb-20 flex flex-col items-center justify-center pb-32">
      <Slider {...settings} className="w-full">
        <>
          <div className="bg-[#71a5cd] rounded-[60px] md:rounded-[80px] p-10 md:p-20 flex flex-col md:items-center space-y-10 mb-10 mx-6">
            <div>
        ...
        <>
          <div className="bg-[#7b5dae] rounded-[60px] md:rounded-[80px] p-10 md:p-20 flex flex-col md:items-center space-y-10 mb-10 mx-6">
            <div>
            ...
            <div className="flex items-center md:justify-center space-x-4 md:space-x-0">
              <div className="h-10 w-12 md:w-20 md:h-10">
                <Image src={"/image/image3.jpg"} alt="image" width={500} height={500} className="rounded-full object-cover h-12 w-12" />
              </div>
              <div className="text-[#1f357f]">
                <div className="font-medium">Alex Berman</div>
                <div className="text-sm">Chief Marketing Sumsung</div>
        ...
        <>
          <div className="bg-[#e1e8bf] rounded-[60px] md:rounded-[80px] p-10 md:p-20 flex flex-col md:items-center space-y-10 mb-10 mx-6">
            <div>
            ...
            <div className="flex items-center md:justify-center space-x-4 md:space-x-0">
              <div className="h-10 w-12 md:w-20 md:h-10">
                <Image src={"/logos/logo1.svg"} alt="image" width={500} height={500} className="rounded-full object-cover h-12 w-12" />
              </div>
              <div className="text-[#1f357f]">
                <div className="font-medium">Alex Berman</div>
                <div className="text-sm">Chief Marketing Sumsung</div>
        ...
        <>
          <div className="bg-[#e3d4ae] rounded-[60px] md:rounded-[80px] p-10 md:p-20 flex flex-col md:items-center space-y-10 mb-10 mx-6">
            <div>
              <Image src={"/image/slick2.svg"} alt="image" width={500} height={500} className="w-40" />
            </div>
            <div className="text-lg font-medium md:text-3xl text-[#1b224b] md:text-center md:w-3/5">
            ...
            <div className="flex items-center md:justify-center space-x-4 md:space-x-0">
              <div className="h-10 w-12 md:w-20 md:h-10">
                <Image src={"/logos/logo6.svg"} alt="image" width={500} height={500} className="rounded-full object-cover h-12 w-12" />
              </div>
              <div className="text-[#1f357f]">
                <div className="font-medium">Alex Berman</div>
                <div className="text-sm">Chief Marketing Sumsung</div>
