    ...
    <div className='md:py-20'>
      <div className='md:text-center space-y-4 px-10'>
        ...
        <div className='text-5xl md:text-7xl flex md:justify-center font-medium md:py-2'>
          Design together with video
        </div>
        <p className='text-xl md:text-3xl font-light md:w-1/2 md:mx-auto text-[#3b394e] leading-normal'>
          From the first presentation to the final pixel, design teams move faster and more efficiently with async video messaging.
        ...
        <div className='pt-10 md:pt-10'>
          <Image src={'/image/image13.webp'} alt='image' width={500} height={500} className="rounded-[20px] md:rounded-[80px] shadow-red-400 shadow-xl md:w-2/3 mx-auto" />
        ...
        <div className='md:justify-center flex'>
          <div className='flex flex-col space-y-6 pb-10'>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To drive product marketing</div>
            </div>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To scale content marketing</div>
            </div>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To streamline team collaboration</div>
            </div>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To promote knowledge sharing</div>
            </div>
