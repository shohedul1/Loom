    ...
    <div className='md:py-20'>
      <div className='md:text-center space-y-4 px-10'>
        ...
        <div className='pt-10 md:pt-10'>
          <Image  src={'/image/image8.webp'} alt='image' width={500} height={500} className="rounded-[20px] md:rounded-[80px] shadow-indigo-400 shadow-xl md:w-2/3 mx-auto" />
         
        </div>

        <div className='text-4xl md:text-7xl flex md:justify-center font-medium pt-20 md:pt-28 pb-10 md:pb-20'>
        Why Design teams use Loom
        ...
        <div className='md:justify-center flex'>
          <div className='flex flex-col space-y-6 pb-20'>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To ensure smooth hand-offs</div>
            </div>
