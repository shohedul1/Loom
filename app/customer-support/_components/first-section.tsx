  ...
  return (
    <div className='md:py-20'>
      <div className='md:text-center space-y-4 px-10'>
        ...
        Use the power and flexibility of video messaging to stay aligned while moving fast and building better products.
        ...
        <div className='pt-10 md:pt-10'>
          <Image  src={'/image/image17.webp'} alt='image' width={500} height={500} className="rounded-[20px] md:rounded-[80px] shadow-yellow-400 shadow-xl md:w-2/3 mx-auto" />
         
        </div>

        <div className='text-4xl md:text-7xl flex md:justify-center font-medium pt-20 md:pt-28 pb-10 md:pb-20'>
        Why Product Management teams use Loom
        ...
        <div className='md:justify-center flex'>
          <div className='flex flex-col space-y-6 pb-20'>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To plan asynchronously</div>
            </div>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To work efficiently with distributed teams</div>
            </div>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To manage team communication</div>
            </div>
            ...
            <div className='flex gap-6 items-center '>
              ...
              <div className='text-xl text-[#224229] font-light'>To launch products</div>
            </div>
