  ...
  return (
    <div className="md:py-20 py-10 bg-[#111019] px-10">
        <div className="md:text-center md:justify-center items-center flex flex-col">
            ...
            Loom&apos;s enterprise-grade platform lets organizations securely communicate using async video.
            </p>

            <div className="mt-20 flex items-center justify-between gap-4 bg-[#565add] text-white px-6 py-4 rounded-full">
            ...
            <div className="pt-28">
                <video
                className="rounded-[40px] shadow-indigo-400 shadow-2xl xl:w-5/6 xl:mx-auto"
                autoPlay
                muted
                loop
                >
