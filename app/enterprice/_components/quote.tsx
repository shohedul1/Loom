  ...
  return (
    <div className='py-10 bg-[#111019]'>
          ...
          <div className="bg-[#1b224b] md:w-3/5 md:mx-auto mx-8 rounded-[60px] md:rounded-[80px] p-10 md:p-20 flex flex-col md:items-center space-y-10 mb-10">
            ...
            Our staff enthusiastically embraced Loom. Rich asynchronous communication is essential to our team's working environment. The Jira Cloud and Confluence integrations are seamless and very powerful.            </div>
