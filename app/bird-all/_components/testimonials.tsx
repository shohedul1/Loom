...
const TenthSection = () => {
  ...
  return (
    <div className="md:pb-20 flex flex-col items-center justify-center pb-32">
        <div className="pt-20 text-3xl px-10 pb-20 font-medium space-y-10">
            <div className="md:text-center md:text-7xl">What customers are saying</div>
            <div className="text-xl md:text-3xl md:w-3/4 md:mx-auto md:text-center text-[#57544] leading-10 font-light">
                73% of Bird users say the AI Suite features are already extremely or very valuable to their workflows
